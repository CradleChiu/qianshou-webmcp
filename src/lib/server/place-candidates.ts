...
const SAME_NAME_DISTANCE_METERS = 60;
const ALIAS_DISTANCE_METERS = 800;
...
function kindFamily(candidate: PlaceCandidate): "transit" | "place" {
  return candidate.kind === "station" || candidate.kind === "transit-stop"
    ? "transit"
    : "place";
}
